...
// This function takes an anwerer object returned by StackOverflow
// and creates a new result to be appended to the DOM
...
// This function gets the top answerers for the tag passed as parameter.
var getTopAnswerers = function (tagName) {
	
	// request parameters to pass to StackOverflow's API
	var request = {tag: tagName,
		           site: 'stackoverflow',
				   period: 'all_time'
				   };
	var result = $.ajax({
